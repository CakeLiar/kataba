...
class MiniGameVoiceOrbs extends StatefulWidget {
  ...
  final List<String> pathToImage = ['assets/images/anf.png', 'assets/images/nml.png', 'assets/images/mlh.png', 'assets/images/mtr.png', 'assets/images/knz.png'];
  final List<String> pathToAudio = ['assets/audio/anf.m4a', 'assets/audio/nml.m4a', 'assets/audio/mlh.m4a', 'assets/audio/mtr.m4a', 'assets/audio/knz.m4a'];
  final List<String> correctWord = ['انف', 'نمل', 'ملح', 'متر', 'كنز'];

  MiniGameVoiceOrbs({required this.id, required this.level, required this.corrects, required this.childId, required this.myScore});

  @override
  State<MiniGameVoiceOrbs> createState() => _MiniGameVoiceOrbsState();
}

const theSource = AudioSource.microphone;


class _MiniGameVoiceOrbsState extends State<MiniGameVoiceOrbs> {
  ...
  void processResultG (String res) {
    ...
    if (instructionStep != 4) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => MiniGameVoiceOrbs(id: widget.id+1, level: widget.level, corrects: r, childId: widget.childId, myScore: widget.myScore,),
        ),
      );
      return;
    }
  ...
  void processResult (String res) {
    ...
    if (instructionStep == 4) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => MiniGameVoiceOrbs(id: widget.id+1, level: widget.level, corrects: widget.corrects, childId: widget.childId, myScore: widget.myScore,),
        ),
      );
      return;
    }
  ...
  void doCheck() {
    if (widget.id == 5) {
      ...
      WidgetsBinding.instance.addPostFrameCallback( (_) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => GreatJob(corrects: widget.corrects, childId: widget.childId, previousId: 1, myScore: widget.myScore,)));
      });
    }
  }
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color(0xFFEDC75C).withOpacity(1),
              Color(0xFFEB84A0).withOpacity(.6),
            ],
        ...
        child: Column(
          ...
          children: [
                          ...
                          builder: (
                            ...
                            return Container(
                              ...
                              child: Card(
                                ...
                                child: Center(child:
                                textOfButton[2]!=''? Container(width: 30, height:30, child:Image.asset('assets/icons/tick.png')) //orbChild(2)
                          ...
                          builder: (
                            ...
                            return Container(
                              ...
                              child: Card(
                                ...
                                child: Center(child:
                                textOfButton[1]!=''?   Container(width: 30, height:30, child:Image.asset('assets/icons/tick.png')) //orbChild(1)
                          ...
                          builder: (
                            ...
                            return Container(
                              ...
                              child: Card(
                                ...
                                child: Center(child:
                                textOfButton[0]!=''?  Container(width: 30, height:30, child:Image.asset('assets/icons/tick.png'))  //orbChild(0)
            ...
            Padding(
              ...
              child: Container(
                height: 50,
                child: slider.Slider( isLoading: isLoading, value: resetSlider, instructionStep: instructionStep, orbBackgroundColor: Color(0xFFEA5753), valueChanged: (double value) async {
                  if (resetSlider == 1) {
    ...
    return Container(
      ...
      child: FloatingActionButton(
        onPressed: !buttonActivated[indx]? (){print("Ok");} : (){
          ...
          if (widget.correctWord[widget.id] == 'نمل' && indx == 0)
            playLetter('assets/audio/na.m4a');
          else if (widget.correctWord[widget.id] == 'ملح' && indx == 2)
            playLetter('assets/audio/hh.m4a');
          else  if (widget.correctWord[widget.id] == 'ملح' && indx == 0)
            playLetter('assets/audio/mi.m4a');
          else if (widget.correctWord[widget.id] == 'متر' && indx == 0)
            playLetter('assets/audio/mi.m4a');
          else if (widget.correctWord[widget.id] == 'متر' && indx == 1)
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                Color(placed == true? 0xFFEA5753 : 0xFF16935D),
